<?php
class getusingtime extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('api/common','common');
		$this->load->model('api/getusingtimemodel','usingtime');
	}
	...
	function index()
	{
		...
		$ret=$this->usingtime->getusingtime($content->sessionkey,$content->productid,$content->startdate,$content->enddate);
		echo json_encode($ret);
	}
}