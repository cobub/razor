...
class Device extends CI_Controller
{
    ...
    function adddevicetypereport($delete = null, $type = null)
    {
        ...
        $this->_data['reportTitle'] = array(
            'activeUserReport' => getReportTitle(lang("t_sessions") . " " . lang("v_rpt_de_top10"), $fromTime, $toTime),
            'newUserReport' => getReportTitle(lang("t_newUsers") . " " . lang("v_rpt_de_top10"), $fromTime, $toTime),
            'timePhase' => getTimePhaseStr($fromTime, $toTime)
        );
        if ($delete == null) {
    ...
    function export()
    {
        ...
        if ($data != null && $data->num_rows() > 0) {
            ...
            // set title name
            $excel_title = array(iconv("UTF-8", "GBK", lang("v_rpt_de_type")), iconv("UTF-8", "GBK", lang("t_sessions")), iconv("UTF-8", "GBK", lang("t_sessionsP")), iconv("UTF-8", "GBK", lang("t_newUsers")), iconv("UTF-8", "GBK", lang("t_newUsersP")));
