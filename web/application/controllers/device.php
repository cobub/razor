...
class Device extends CI_Controller
{
	...
	function index()
	{
		...
		$this->data['activeuser'] = $this->operator->getActiveUsersPercentByDevice($fromTime,$toTime,$productId);
		$this->data['newuser'] = $this->operator->getNewUserPercentByDevice($fromTime,$toTime,$productId);
