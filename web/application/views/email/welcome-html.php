...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/login/'); ?>" style="color: #3366cc;"><?php echo lang('e_enter') ?> <?php echo $site_name; ?>！</a></b></big><br />
<br />
