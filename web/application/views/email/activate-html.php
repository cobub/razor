...
<?php echo lang('allview_thanksinfo') ?><?php echo $site_name; ?><?php echo lang('activatehtml_finshregister') ?><br />
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;"><?php echo lang('activatehtml_finshiregist') ?></a></b></big><br />
<br />
<?php echo lang('activatehtml_contentlink') ?><br />
...
<br />
<?php echo lang('activatehtml_contentplease') ?><?php echo $activation_period; ?><?php echo lang('activatehtml_contentcheck') ?><br />
<br />
<br />
