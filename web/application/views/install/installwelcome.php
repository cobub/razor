...
<p align="center"> &copy; Copyright 2012-2015 Cobub Razor  Version:<?php  echo $this->config->item('version')?>
 ...
 <a hreft ="http://dev.cobub.com" target ="_blank" title="Mobile Analytics" alt="Cobub Razor - Open Source Mobile Analytics Solution">Mobile Analytics of Open Source</a></p></div>
</html>
<script type="text/javascript">
function isaccpet()
{
