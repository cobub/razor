    ...
    echo $newurl.'/assets/images/ecobubrazorlogo.png';
       ...
       echo $newurl.'/assets/images/ecobubrazorlogo.png';
        ...
        <hr style="color:#9FA0A2;" />
            ...
            <p><?php if(isset($curlerror)) echo $curlerror;?></p>
            <p><?php if(isset($mbstringerror)) echo $mbstringerror;?></p>
            ...
            <div style="position:absolute;top:300px;left:420px;"   >
             ...
             <table class="tablesorter" cellspacing="0">
                ...
                <tr><td><?php echo lang('installview_checkcurl');?></td><td>                
                 <?php if (isset($curl)&&$curl=="true") {
                     echo  '<img src="'.$newurl.'/assets/images/icn_alert_success.png"/>';
} else {
                           echo '<img src="'.$newurl.'/assets/images/icn_alert_error.png"/>';
}
                ...
                <tr><td><?php echo lang('installview_checkmbstring');?></td><td>                
                 <?php if (isset($mbstring)&&$mbstring=="true") {
                     echo  '<img src="'.$newurl.'/assets/images/icn_alert_success.png"/>';
} else {
                          echo '<img src="'.$newurl.'/assets/images/icn_alert_error.png"/>';
}
...
if ($language=="zh_CN") { 
    echo '<p style="font-size: 16px;font-weight: bold;">安装帮助</p>';
        ...
        <ul  class="tabs">
        <div>        
        <a href='<?php if ($phpversion=="true"&&$mysqli=="true"&&$writetrue=="true"&&$curl=="true"&&$mbstring=="true") {
            echo $newurl.'/index.php?/install/installation/databaseinfo/'.$language;
} else {
                echo $newurl.'/index.php?/install/installation/systemcheck/'.$language;
} ?>'>
...
if ($language == "zh_CN") {
 ...
 <?php if ($language=="zh_CN") {
    ...
    " target ="_blank" title="<?php if ($language == 'zh_CN') {
                                       echo '移动应用分析';
} else {
