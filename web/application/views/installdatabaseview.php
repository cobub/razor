...
<body>
    ...
    if($language=="chinese"){ echo $newurl.'/assets/images/cobub-razor-logo.png';}
     ...
     <hr style="color:#9FA0A2;" />
			...
			<form method="post" action="<?php echo $newurl; ?>/index.php?/main/createdatabase">
			...
			<p align="left" class="STYLE5"><?php echo lang('installview_dataset') ;?></p>			
             <table class="tablesorter" cellspacing="0">
               ...
               <td><?php echo form_error('ip'); ?></td></tr>
                ...
                <tr><td><?php echo lang('installview_datapassword') ;?></td><td><input name='password' type="password" value="<?php echo set_value('password'); ?>"></input></td><td><?php echo form_error('password'); ?></td></tr>
			...
			<p align="left" class="STYLE5"><?php echo lang('installview_datadepotset') ;?></p>			
             <table class="tablesorter" cellspacing="0">
               ...
               <td><?php echo form_error('depotip'); ?></td></tr>
                ...
                <tr><td><?php echo lang('installview_datadepotpwd') ;?></td><td><input name='depotpassword' type="password" value="<?php echo set_value('depotpassword'); ?>"></input></td><td><?php echo form_error('depotpassword'); ?></td></tr>
