...
<?php endif;?>
	...
	<article class="module width_full">
		...
		<div class="module_content">
			<p style="font-size: 13px;"> <?php echo lang('v_plugins_introduce1') ?><a href="http://dev.cobub.com" target="_blank"><?php echo lang('v_plugins_introduce2') ?>&nbsp</a><?php echo lang('v_plugins_introduce3') ?>&nbsp<a href="http://dev.cobub.com/users" target="_blank"><?php echo lang('v_plugins_introduce4') ?>&nbsp</a><?php echo lang('v_plugins_introduce5') ?><b>
			<a href="http://dev.cobub.com/users" target="_blank"><?php echo lang('plg_getkey')?></a></b>
			</p>
		...
		<footer>
			<div class="submit_link">
					<input type='submit' id='submit' class='alt_btn'
						name="userkey/save" value=<?php echo lang('plg_save') ?>>
			</div>
		</footer>
		<?php echo form_close(); ?>
