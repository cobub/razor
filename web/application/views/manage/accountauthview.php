    ...
    text-decoration: underline
        ...
        <div class="module_content">
            ...
            <br />
                    ...
                    <a href="<?php if($language=='zh_CN') echo 'http://www.cobub.com/users/index.php?/help/userkey';else echo 'http://www.cobub.com/users/en/index.php?/help/userkey';?>" target="_blank"><?php echo lang('plg_getkey')?></a>
                    </b>
            </p>
