...
<section id="main" class="column">
  <article class="module width_full">
    <header>
      <h3><?php echo lang('v_man_oc_sendPC') ?></h3>
    </header>
    <div class="module_content">
      <table class="tablesorter" cellspacing="0">
        <tbody>
          <tr>
            <td><input name="autogetlocation" type="checkbox" value="1"
              id="autogetlocation"
              <?php if ($autogetlocation['value']==1)   echo 'checked';?> /><?php echo lang('v_man_oc_setAutoPos') ?></td>
          </tr>
          <tr>
            <td><input name="updateonlywifi" type="checkbox" value="1"
              id="updateonlywifi"
          ...
          <tr>
            <td><input type="radio" name="reportPolicy" value="0"
              <?php if ($reportpolicy['value']==0) {
                               echo 'checked';
}?>><?php echo lang('v_man_oc_sendDataOnStarted') ?></td>
          </tr>

          <tr>

            <td><input type="radio" name="reportPolicy" value="1"
              <?php if ($reportpolicy['value']==1) {
                              echo 'checked value=1';
}?>><?php echo lang('v_man_oc_sendDataInRealTime') ?></td>
          </tr>
