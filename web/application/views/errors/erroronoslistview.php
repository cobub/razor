...
<table class="tablenosorter" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="15%"><?php echo  lang('v_rpt_os_version')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 		
		...
		msg += '<a href=<?php echo site_url();?>/report/erroronos/detailstacktrace/'+data[i+index].title_sk+'/'+data[i+index].deviceos_sk+'>';
		msg = msg + data[i+index].title;
		msg += '</a>';
		msg = msg + "</td><td>";
		msg = msg + data[i+index].deviceos_name;
		msg = msg + "</td><td>";
