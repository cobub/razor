...
<a href ="<?php echo site_url().'/report/errorondevice'?>">
...
var devicebrand_sk='<?php echo isset($devicebrand_sk)?$devicebrand_sk:""?>';
...
$(document).ready(function() {
    ...
    {	
    	myurl="<?php echo site_url()?>/report/errorondevice/getVersionInfoOnDevice/"+titlesk+"/"+devicebrand_sk;	
    	...
    	options.subtitle.text = '<?php echo $reportTitle['timePhase'];?>';
  	    ...
  	    {  	
  		    ...
  		    obj.name = deviceContent.version_name;
    ...
    {	
    	myurl="<?php echo site_url()?>/report/errorondevice/getOsInfoOnDevice/"+titlesk+"/"+devicebrand_sk;	
...
function initPagination() {
 ...
 function pageselectCallback(page_index, jq){
	...
	'<th width="20%"><?php echo lang("v_rpt_ve_appVersion") ?></th>'+
