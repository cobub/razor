...
var version_name='<?php echo isset($version_name)?$version_name:""?>';
...
<a href ="<?php echo site_url().'/report/errorlog'?>">
<?php echo lang('v_rpt_err_errorList') ?>
</a>

<?php 
$status = $isfix =="0"?lang('v_rpt_err_unrepaired'):lang('v_rpt_err_repairedE');
?>
<label id='fix_status' style="color:#FF9224">
<?php echo $status;?>
</label>
...
<ul class="tabs">
	...
	<li><a id="OSDistribution"
		href="#tab4"><?php echo lang('v_rpt_err_OSDistribution') ?></a></li>
</ul>
</header>
...
$(document).ready(function() {
	...
	options1={		
                 ...
                 title: {"text":"<?php echo lang('v_rpt_err_OSDistributionComment') ?>"},   
                 subtitle: {
                     text: ' '
                 },             
    ...
    {	
    	myurl="<?php echo site_url()?>/report/errorlog/getDeviceInfoOfVersion/"+titlesk+"/"+version_name;	
    ...
    {	
    	myurl="<?php echo site_url()?>/report/errorlog/getOsOfVersion/"+titlesk+"/"+version_name;	
...
function initPagination() {
 ...
 function pageselectCallback(page_index, jq){
	...
	'<th width="40%"><?php echo lang("v_rpt_os_version") ?></th>'+			
	...
	{ 
		...
		msg = msg + "</td><td>";
		msg = msg + data[err_index].deviceos_name;
		msg = msg + "</td><td>";
