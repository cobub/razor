...
<table class="tablenosorter" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="15%"><?php echo  lang('v_rpt_err_device')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		...
		msg += '<a href=<?php echo site_url();?>/report/errorondevice/detailstacktrace/'+data[i+index].title_sk+'/'+data[i+index].devicebrand_sk+'>';
		msg = msg + data[i+index].title;
		msg += '</a>';
		msg = msg + "</td><td>";
		msg = msg + data[i+index].devicebrand_name;
		msg = msg + "</td><td>";
