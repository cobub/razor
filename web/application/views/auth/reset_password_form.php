...
<section id="main" class="column">
		<h4 class="alert_info"><?php echo lang('l_welcomeCR') ?></h4>
		
<article class="module width_full">
<header><h3><?php echo lang('m_resetPassword') ?></h3></header>
	<div class="module_content">
<table>
	<tr>
		<td><?php echo form_label(lang('m_cp_newPassword'), $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label(lang('l_re_confirmPassword'), $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', lang('m_changePassword')); ?>
</div>
</article>
</section>
<?php echo form_close(); ?>