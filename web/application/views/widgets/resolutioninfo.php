...
function renderCharts(myurl) 
{
    ...
    jQuery.getJSON(myurl, null, function (data) {
        ...
        for (i = 0; i < obj.length; i++) {
            ...
            if (obj[i].deviceresolution_name.length < 1)
                obj[i].deviceresolution_name = 'unknown';
            sessionCategories.push(obj[i].deviceresolution_name);
        ...
        for (i = 0; i < objNewUserData.length; i++) {
            ...
            if (objNewUserData[i].deviceresolution_name.length < 1)
                objNewUserData[i].deviceresolution_name = 'unknown';
            newUserCategories.push(objNewUserData[i].deviceresolution_name);
