...
function renderCharts(myurl) {
    ...
    jQuery.getJSON(myurl, null, function (data) {
        ...
        for (i = 0; i < obj.length; i++) {
            ...
            if (obj[i].devicesupplier_name.length < 1)
                obj[i].devicesupplier_name = 'unknown';
            sessionCategories.push(obj[i].devicesupplier_name);
        ...
        for (i = 0; i < objNewUserData.length; i++) {
            ...
            if (objNewUserData[i].devicesupplier_name.length < 1)
                objNewUserData[i].devicesupplier_name = 'unknown';
            newUserCategories.push(objNewUserData[i].devicesupplier_name);
